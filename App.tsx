...
const AiroErrorBoundary = import.meta.env.MODE === 'development'
  ? lazy(() =>
      import('../dev-tools/src/AiroErrorBoundary').catch(() => ({
        default: ({ children }: { children: React.ReactNode }) => <>{children}</> as unknown as InstanceType<typeof import('../dev-tools/src/AiroErrorBoundary').default>,
...
const routeTree: RouteObject[] = [
  {
    element:
      import.meta.env.MODE === 'development' && AiroErrorBoundary ? (
