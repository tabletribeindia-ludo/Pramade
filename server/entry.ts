...
import ordersPost from "./api/orders/POST";
import waitlistGet from "./api/waitlist/GET";
import waitlistPost from "./api/waitlist/POST";
import profileGet from "./api/account/profile/GET";
import profilePut from "./api/account/profile/PUT";
import ordersGet from "./api/account/orders/GET";
import savedItemsGet from "./api/account/saved-items/GET";
import savedItemsPost from "./api/account/saved-items/POST";
import savedItemsDelete from "./api/account/saved-items/DELETE";
import preferencesGet from "./api/account/preferences/GET";
import preferencesPut from "./api/account/preferences/PUT";
// </api-imports>
...
// <api-registrations>
app.all("/api/auth/:action", authActionGet);
app.all("/api/auth/:action/:detail", authActionDetailGet);
app.post("/api/cart", cartPost);
app.get("/api/health", healthGet);
app.post("/api/orders", ordersPost);
app.get("/api/waitlist", waitlistGet);
app.post("/api/waitlist", waitlistPost);
app.get("/api/account/profile", profileGet);
app.put("/api/account/profile", profilePut);
app.get("/api/account/orders", ordersGet);
app.get("/api/account/saved-items", savedItemsGet);
app.post("/api/account/saved-items", savedItemsPost);
app.delete("/api/account/saved-items/:id", savedItemsDelete);
app.get("/api/account/preferences", preferencesGet);
app.put("/api/account/preferences", preferencesPut);
// </api-registrations>
// </api-registrations>
